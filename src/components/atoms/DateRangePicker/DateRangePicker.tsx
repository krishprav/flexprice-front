...
/**
 * `DateRangePicker` is the analytics and billing range selector used throughout
 * FlexPrice.
 *
 * It opens a two-month calendar popover, supports local/UTC display, accepts
 * optional min/max date constraints, and reports selected dates through a
