...
/**
 * `Chip` renders compact status and metadata labels used across FlexPrice.
 *
 * It covers success, warning, failed, info, and neutral states, supports optional
 * icons and trailing content, and can be made clickable for filter/tag controls.
 */
