...
/**
 * `Tooltip` wraps Radix Tooltip with FlexPrice defaults for short contextual
 * help.
 *
 * Use it for labels, icon buttons, and compact table values where the UI needs
 * explanatory text without changing the surrounding layout.
 */
