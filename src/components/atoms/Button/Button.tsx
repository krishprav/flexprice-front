...
/**
 * `Button` is the primary action control used across FlexPrice forms, tables,
 * dialogs, and page headers.
 *
 * It supports FlexPrice visual variants, size presets, loading/disabled states,
 * optional prefix/suffix icons, and Radix `Slot` composition through `asChild`.
 */
