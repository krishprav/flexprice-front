...
/**
 * `FlexPriceSelect` is a single-select dropdown built on Radix Select.
 *
 * It is used for billing models, currencies, statuses, and table filters, with
 * support for labels, descriptions, error text, required markers, disabled
 * options, radio-style items, and custom trigger/content rendering.
 */
