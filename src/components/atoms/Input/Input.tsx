...
/**
 * `Input` is the standard FlexPrice form field for text, numeric, currency, and
 * integer values.
 *
 * It renders an optional label, helper text, error message, prefix/suffix slots,
 * size variants, and number formatting while preserving a simple string
 * `onChange` API for forms.
 */
